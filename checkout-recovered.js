(async () => {
  ...
  const renderPayment = () => {
    ...
    formSection.innerHTML = `<div class="space-y-4">
      <div><h2 style="font-size:18px;font-weight:700;color:rgb(23 23 23);margin:0">Pagamento seguro</h2><p style="font-size:12px;color:rgb(115 115 115);margin:5px 0 0">Escolha Pix ou cartão e conclua sua compra em um ambiente protegido.</p></div>
      <div style="border:1px solid rgb(229 229 229);border-radius:14px;padding:16px;display:flex;align-items:center;gap:13px"><div style="width:48px;height:48px;border-radius:12px;background:rgb(236 253 245);color:rgb(5 150 105);display:grid;place-items:center"><svg aria-hidden="true" viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10Z"></path><path d="m9 12 2 2 4-4"></path></svg></div><div style="min-width:0"><strong style="display:block;font-size:14px;color:rgb(23 23 23)">Pagamento protegido</strong><span style="display:block;font-size:12px;color:rgb(115 115 115);margin-top:2px">Pix e cartão de crédito</span></div><span style="margin-left:auto;font-size:11px;font-weight:700;color:rgb(5 150 105);background:rgb(236 253 245);padding:6px 9px;border-radius:999px">Seguro</span></div>
